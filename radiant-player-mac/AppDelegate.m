...
- (void)webView:(WebView *)sender didFinishLoadForFrame:(WebFrame *)frame
{
    ...
    if ([[webView mainFrameDocument] querySelector:@"#playerSongInfo"]) {
        ...
        [self evaluateJavaScriptFile:@"jquery.min"];
        [self evaluateJavaScriptFile:@"google.music"];
        [self evaluateJavaScriptFile:@"utils"];
        [self evaluateJavaScriptFile:@"dom_listener"];
